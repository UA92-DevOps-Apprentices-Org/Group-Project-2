      ...
      <div className="mt-32 px-96 w-full border-red-500 outline-4">
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(0deg, rgba(46, 44, 47, 0.69) 0%, rgba(46, 44, 47, 0.69) 100%), linear-gradient(180deg, rgba(171, 106, 172, 0.50) 0%, rgba(15, 14, 15, 0.50) 100%), url(<path-to-image>), lightgray 0% 0% / 100px 100px repeat",
